 ...
 * Return: If memory allocation fails or @the_end is NULL,
 * return NULL. Otherwise, return a pointer to the newly created node.
 */
...
/**
 * free_command_lst - Frees memory allocated for a linked list.
...
/**
 * free_command_btree - Frees memory allocated for a
 * binary tree of cmd_btree_lst.
 ...
 * Return: A pointer to the tokens if successful, NULL if the list
 * is empty or 'head' is NULL.
 */
